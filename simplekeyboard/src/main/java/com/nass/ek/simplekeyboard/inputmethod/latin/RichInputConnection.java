...
import com.nass.ek.simplekeyboard.inputmethod.latin.common.UnicodeSurrogate;
import com.nass.ek.simplekeyboard.inputmethod.latin.settings.SpacingAndPunctuations;
import com.nass.ek.simplekeyboard.inputmethod.latin.utils.CapsModeUtils;
import com.nass.ek.simplekeyboard.inputmethod.latin.utils.DebugLogUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.nass.ek.simplekeyboard.inputmethod.latin.common.Constants.UnicodeSurrogate
